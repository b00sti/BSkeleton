package com.example.bskeleton.android.activities;
...
public abstract class BaseInnerViewActivity extends AppCompatActivity {
    ...
    private void setInitialFragment(Intent intent) {
        int fragmentId;
        if (intent.hasExtra(getString(R.string.inner_activity_bundle_fragment))) {
            fragmentId = intent.getIntExtra(getString(R.string.inner_activity_bundle_fragment), -1);
